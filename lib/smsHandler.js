...
smsHandlers.smsApi = (data, callback) => {

    const source = 'Kedebah'

    const url = `https://deywuro.com/api/sms?username=kedebah&password=mv6@@hx&source=${source}&destination=${data.payload.phoneNumber}&message=${data.payload.message}`
